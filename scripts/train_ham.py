...
def main():
    ...
    batch_size = 63 # needs to be divisible by n classes
    ...
    # Train models with varying n latent dims
    #for dim in [2, 16, 32, 64]:
    for dim in [16]:
        # Init model
        ...
        model, history = train_sae_sequential(model, train_dataset, epochs=150, batch_size=batch_size, sampler=balanced_sampler)
